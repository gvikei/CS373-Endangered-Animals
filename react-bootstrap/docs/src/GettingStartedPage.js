  ...
  export default class Page extends React.Component {
    ...
    render() {
      ...
      <div class="row">
        <div class="col-6">
        <h2 className="page-header"><Anchor id="tools">Tools</Anchor></h2>
      ...
      <div class="col-6">
        <h2 className="page-header"><Anchor id="data-sources">Data Sources</Anchor></h2>
      ...
      <h2 className="page-header"><Anchor id="team">Technical​​ Report</Anchor></h2>
