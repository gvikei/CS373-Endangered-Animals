         ...
         <PageHeader
          ...
          subTitle={this.state.subTitle}/>
           ...
           <BootstrapTable data={this.state.model} striped={true} hover={true} ref='table' pagination={true} search={true} columnFilter={true} options={options}>
            ...
            <TableHeaderColumn width='200' dataField="citationLink"         dataAlign="center" dataSort={true}                                      > Citation             </TableHeaderColumn>
            ...
            <TableHeaderColumn width='200' dataField="assoc_threats"        dataAlign="center" dataSort={true}  dataFormat={this.threatFormatter}   > Associated Threats   </TableHeaderColumn>
            <TableHeaderColumn width='200' dataField="assoc_habitats"       dataAlign="center" dataSort={true}  dataFormat={this.habitatFormatter}  > Associated Habitats  </TableHeaderColumn>
            <TableHeaderColumn width='200' dataField="assoc_countries"      dataAlign="center" dataSort={true}  dataFormat={this.countryFormatter}  > Associated Countries </TableHeaderColumn>
          </BootstrapTable>
