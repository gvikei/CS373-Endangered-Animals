            ...
            <div className="container bs-docs-container bs-docs-single-col-container">
              <div className="bs-docs-section">
                ...
                <Row>
                    ...
                    <h3>Shiva Velingker</h3>
                      <div class="card-body">
                        ...
                        <p class="card-text">
                          ...
                          <br/>
                          <a target="_blank" href="https://shivavelingker.github.io">https://shivavelingker.github.io</a>
                        </p>
                        <Row className="show-grid">
                  ...
                  <Col sm={4}>
                    <Thumbnail src="https://scontent.fftw1-1.fna.fbcdn.net/v/t1.0-9/1526234_708244945861491_140470993_n.jpg?oh=71349007847dc4a0532f9a9daffefda2&oe=5A97A649" alt="242x200">
                    <h3>Dat Vu</h3>
                      <div class="card-body">
                        <h6 class="card-subtitle mb-3 text-muted">Worked on back-end & database.</h6>
                        <p class="card-text">
                ...
                <Row>
                  <Col sm={4}>
                    <h2> Tools </h2>
                      <p><a target="_blank" href="http://www.apiary.io" target="_blank">Apiary</a>: Documentation tool for our RESTful API, used to document our RESTful API. <a target="_blank" href="http://docs.endangeredanimals.apiary.io/" target="_blank">Link to our API documentation.</a></p>
                      <p><a target="_blank" href="http://www.trello.com" target="_blank">Trello</a>: Project management tool used to track tasks and issues. <a target="_blank" href="https://trello.com/b/9W2VbqWT/part-1" target="_blank">Link to our Trello</a></p>
                      <p><a target="_blank" href="http://www.planitpoker.com" target="_blank">PlanItPoker</a>: Project management tool used to estimate the amount of time a task would take to complete.</p>
                      <p><a target="_blank" href="http://www.nc.me" target="_blank">Namecheap</a>: Domain name registration site used to obtain a name for our website.</p>
                      <p><a target="_blank" href="http://flask.pocoo.org/" target="_blank">Flask</a>: Web microframework for backend Python that was used to connect our HTML templates to our URL address, as well as develop a RESTful API.</p>
                      <p><a target="_blank" href="http://www.github.com" target="_blank">Github</a>: Web-based Git version control software that was used to maintain the source code. <a target="_blank" href="https://github.com/gvikei/idb/" target="_blank">Link to our Github repo</a></p>
                      <p><a target="_blank" href="http://getbootstrap.com/" target="_blank">Bootstrap</a>: Front-end framework used to design our webpages.</p>
                  </Col>

                  <Col sm={4}>
                    <h2> Data Sources </h2>
                      <a target="_blank" class="text-justify" href="http://apiv3.iucnredlist.org/api/v3/docs">IUCN Red List API - v3</a>
                      ...
                      <a target="_blank" class="text-justify" href="https://developers.google.com/youtube/v3/docs/search/list">Youtube Data API</a>
                      ...
                      <a target="_blank" class="text-justify" href="https://developers.google.com/maps/documentation/geocoding/start">Google Geocoding API</a>
                      ...
                      <a target="_blank" class="text-justify" href="https://azure.microsoft.com/en-us/services/cognitive-services/bing-image-search-api/">Bing Image Search</a>
                  ...
                  <Col sm={4}>
                    ...
                    <p><a target="_blank" href="https://gitpitch.com/gvikei/idb#/">Git Pitch​​ for​​ Group​​ 22</a></p>
                    <p><a target="_blank" href="https://bryanlng.gitbooks.io/group-22-technical-report/content/">Technical​​ Report​​ for​​ Group​​ 22</a></p>
                    <p><a target="_blank" href="https://utexas.app.box.com/s/jt8v5blmmxemsq27f3s35tzo197qmosv">UML Design for Group​​ 22</a></p>
                  </Col>
                </Row>
