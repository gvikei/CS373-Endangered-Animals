            ...
            <div className="container bs-public-container bs-public-single-col-container">
              <div className="bs-public-section">
                ...
                <Row>
                  <Col sm={4}>
                    <h2> Tools </h2>
                      <p><a href="http://www.apiary.io" target="_blank">Apiary</a>: Documentation tool for our RESTful API, used to document our RESTful API. <a href="http://public.endangeredanimals.apiary.io/" target="_blank">Link to our API documentation.</a></p>
                  ...
                  <Col sm={4}>
                    <h2> Data Sources </h2>
                      <a class="text-justify" href="http://apiv3.iucnredlist.org/api/v3/public">IUCN Red List API - v3</a>
                      ...
                      <a class="text-justify" href="https://developers.google.com/youtube/v3/public/search/list">Youtube Data API</a>
