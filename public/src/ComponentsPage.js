  ...
  render() {
    return (
      <div>
        ...
        <div ref="main" className="container bs-public-container">
          <div className="row">
            <div className="col-md-9" role="main">
              ...
              <div className="bs-public-section">
                ...
                <p>
                  ...
                  You can check out how we implemented it on the side panel here by reading the <a href="https://github.com/react-bootstrap/react-bootstrap/blob/master/public/src/ComponentsPage.js">public source</a>.
                </p>
              </div>
            </div>


            <div className="col-md-3 bs-public-sidebar-holder">
              <AutoAffix
                viewportOffsetTop={20}
                container={this.getMain}
              >
                <div
                  className="bs-public-sidebar hidden-print"
                  role="complementary"
                >
                  <Nav
                    className="bs-public-sidenav"
