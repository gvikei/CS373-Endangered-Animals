...
- http://svn.apache.org/repos/asf/httpd/httpd/trunk/public/conf/mime.types
...
- `.source` - where the mime type is defined.
    ...
    - `apache` - [Apache common media types](http://svn.apache.org/repos/asf/httpd/httpd/trunk/public/conf/mime.types)
