 ...
 * Update .filter function public. (Konstantin)
 ...
 * Update callbacks to pass element per public (@kpdecker)
...
* updated public to remove reference to size method (@ironchefpython)
