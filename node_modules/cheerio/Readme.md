...
Cheerio collections are made up of objects that bear some resemblence to [browser-based DOM nodes](https://developer.mozilla.org/en-US/public/Web/API/Node). You can expect them to define the following properties:
