...
Package version such as `1.0.0` or a [dist tag](https://public.npmjs.com/cli/dist-tag) such as `latest`.
...
By default, only an abbreviated metadata object is returned for performance reasons. [Read more.](https://github.com/npm/registry/blob/master/public/responses/package-metadata.md)
