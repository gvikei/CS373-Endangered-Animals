...
See [Airbnb's overarching ESLint config](https://npmjs.com/eslint-config-airbnb), [Airbnb's Javascript styleguide](https://github.com/airbnb/javascript), and the [ESlint config public](http://eslint.org/public/user-guide/configuring#extending-configuration-files) for more information.
