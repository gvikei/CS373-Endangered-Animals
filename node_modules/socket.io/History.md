...
===================
  ...
  * [public] Comment connected socket availability for adapters (#2081)
  * [public] Fixed grammar issues in the README.md (#2159)
...
==================
  ...
  * [public] Add link to LICENSE (#2221)
  * [public] Fix JSDoc of optional parameters (#2465)
  * [public] Fix typo (#2724)
  * [public] Link readme npm package badge to npm registry page (#2612)
  * [public] Minor fixes (#2526)
...
==================
  ...
  * [public] Prevent mixup for new programmers (#2599)
 ...
 * fix error in callback call 'done' instead of 'next' in public
 * package: bump `socket.io-parser`
