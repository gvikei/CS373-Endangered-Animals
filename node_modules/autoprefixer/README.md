...
See [Browserslist public] for queries, browser names, config format,
and default value.

[Browserslist public]: https://github.com/ai/browserslist#queries
...
[PostCSS warning API]: https://github.com/postcss/postcss/blob/master/public/api.md#warning-class
...
* `browsers` (array): list of browsers query (like `last 2 versions`),
  ...
  to share browsers with other tools. See [Browserslist public] for available
...
[PostCSS API]:      https://github.com/postcss/postcss/blob/master/public/api.md
