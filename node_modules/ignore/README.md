...
`ignore` is a manager, filter and parser which implemented in pure JavaScript according to the .gitignore [spec](http://git-scm.com/public/gitignore).
...
- Exactly according to [gitignore man page](http://git-scm.com/public/gitignore), fixes some known matching issues of fstream-ignore, such as:
