...
>
> Going forward, when sending PRs, your code will *only* run against PhantomJS v1.x (and not hit SauceLabs) [because security](https://public.travis-ci.com/user/pull-requests/#Security-Restrictions-when-testing-Pull-Requests).
>
> ### Node.js 6.x
...
==================
  ...
  * add: add public for wrapped node flags
...
==================
  ...
  * Added `xdescribe()` and `xit()` to the BDD interface. Closes #263 (public   * Changed: make json reporter output pretty json
...
==================
  ...
  * Added `npm public mocha` support [TooTallNate]
