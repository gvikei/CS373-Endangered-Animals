...
==================
  ...
  * Fix a small bug in the .null assertion public
...
==================
  ...
  * config.truncateThreshold public: simpler wording
  * Add missing publictring for showDiff argument of assert
 ...
 * Fix public for overwriteChainableMethod parameters
 ...
 * typos in public
 * minor public typo
 * update public: getAllFlags -> transferFlags
 ...
 * Add public for function style NOOP asserts
...
==================
  ...
  * public: [config] make public, express param type
...
==================
  ...
  * public: add contributing.md #238
 ...
 * public: add sauce badge to readme [ci skip]
...
==================
  ...
  * public: fix typo in source file. #174
...
==================
  ...
  * public: add Release Notes for non-gitlog summary of changes.
...
==================
  ...
  * fixes #79
  * browser build
  * expand  public to indicate change of subject for chaining. Closes #78
  * add `that` chain noop
  * Merge branch 'bug/74'
...
==================
  ...
  * Uniformize `assert` interface inline public.
  * Don't use `instanceof` for `assert.isArray`.
  * Add `deep` flag for equality and property value.
  * Merge pull request #64 from chaijs/assertion-public
  * Uniformize assertion inline public.
...
==================
  ...
  * doc test suite
  * public don't need coverage
  * refactor all simple chains into one forEach loop, for clean documentation
  * updated npm ignore
  * remove old public
  * public checkpoint - guide styled
  * Merge pull request #59 from joliss/doc
  * Document how to run the test suite
  * don't need to rebuild public to view
  * dep update
  * public checkpoint - api section
  * comment updates for public
  ...
  * updated plugins list for public
...
==================
  ...
  * public build
  * templates for public express app for plugin directory
  ...
  * Merge branch 'refs/heads/0.6.x-public' into 0.6.x
  * Added guide link to public. WIP
  ...
  * [public] new site homepage layout / color checkpoint
  ...
  * [public] comments for getMessage utility
  * [feature] getMessage
...
==================
  ...
  * dev public update for Assertion#assert
...
==================
  ...
  * public and readme for upcoming 0.4.0
  * public generated
  * putting coverage and tests for public in public/out/support
  * make public
  * makefile copy necessary resources for tests in public
  * rename configuration test
  * Merge pull request #21 from logicalparadox/close-to
  * Update the browser version.
  * Update `closeTo()` public.
...
==================
  ...
  * Fix typo for instanceof public. Closes #3 [ci skip]
