...
[`Worker`](https://developer.mozilla.org/en/public/Web/API/Worker) interface.
...
- `baseURL` (`Object` | `String`): An object or string representing
  ...
  optional and defaults to [`location`](https://developer.mozilla.org/en-US/public/Web/API/Location)
  in the browser.
