...
SockJS.prototype.close = function(code, reason) {
  ...
  // TODO look at public to determine how to set this
  var wasClean = true;
...
AbstractXHRObject.prototype._start = function(method, url, payload, opts) {
  ...
  if ((!opts || !opts.noCredentials) && AbstractXHRObject.supportsCORS) {
    ...
    // Mozilla public says https://developer.mozilla.org/en/XMLHttpRequest :
...
JsonpReceiver.prototype._createScript = function(url) {
  ...
  if (typeof script.async === 'undefined' && global.document.attachEvent) {
    // According to mozilla public, in recent browsers script.async defaults
...
function useColors() {
  ...
  return (typeof document !== 'undefined' && document && document.documentElement && document.documentElement.style && document.documentElement.style.WebkitAppearance) ||
    ...
    // is firefox >= v31?
    // https://developer.mozilla.org/en-US/public/Tools/Web_Console#Styling_messages
