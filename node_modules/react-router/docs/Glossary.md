...
This is a glossary of common terms used in the React Router codebase and documentation listed in alphabetical order, along with their [type signatures](http://flowtype.org/public/quick-reference.html).
...
A *component* is a React component class or a string (e.g. "div"). Basically, it's anything that can be used as the first argument to [`React.createElement`](https://facebook.github.io/react/public/top-level-api.html#react.createelement).
...
New locations are typically created each time the URL changes. You can read more about locations in [the `history` public](https://github.com/mjackson/history/blob/v2.x/public/Location.md).
...
You can read more about location descriptors in [the `history` public](https://github.com/mjackson/history/blob/v2.x/public/Location.md).
...
[pushState]: https://developer.mozilla.org/en-US/public/Web/API/History_API#The_pushState()_method
[replaceState]: https://developer.mozilla.org/en-US/public/Web/API/History_API#The_replaceState()_method
