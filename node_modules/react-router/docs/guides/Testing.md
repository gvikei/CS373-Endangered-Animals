...
====================
Testing has become much easier since React Router version 1.x. For Testing prior React Router versions, see   [Old testing public](https://github.com/reactjs/react-router/blob/57543eb41ce45b994a29792d77c86cc10b51eac9/public/guides/testing.md).

It is recommended that you read the following two tutorials prior:
- [Jest Getting Started public](https://facebook.github.io/jest/public/getting-started.html)
- [Jest ReactJS public](https://facebook.github.io/jest/public/tutorial-react.html)
- [ReactJS TestUtils public](https://facebook.github.io/react/public/test-utils.html)
