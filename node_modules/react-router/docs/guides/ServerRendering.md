...
To facilitate these needs, you drop one level lower than the [`<Router>`](/public/API.md#Router) API with:  

- [`match`](/public/API.md#match-routes-location-history-options--cb) to match the routes to a location without rendering
