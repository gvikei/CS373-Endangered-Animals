...
Internally, the router converts your `<Route>` element hierarchy to a [route config](/public/Glossary.md#routeconfig). But if you're not digging the JSX you can use plain objects instead:
...
The public about [route configuration](/public/guides/RouteConfiguration.md) describe more of the router's features in depth.
