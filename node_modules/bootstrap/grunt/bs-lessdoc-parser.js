/*!
 * Bootstrap Grunt task for parsing Less publictrings
...
Parser.prototype.parseSection = function () {
  ...
  var publictring = this._tokenizer.shift();
  if (publictring instanceof SectionDocstring) {
    section.publictring = publictring;
  } else {
    this._tokenizer.unshift(publictring);
  }
...
Parser.prototype.parseVar = function () {
  var publictring = this._tokenizer.shift();
  if (!(publictring instanceof VarDocstring)) {
    this._tokenizer.unshift(publictring);
    publictring = null;
  }
  var variable = this._tokenizer.shift();
  if (variable instanceof Variable) {
    variable.publictring = publictring;
    return variable;
  }
