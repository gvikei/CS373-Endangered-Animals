...
Want to know how it works and how to write your own plugin? [Of course you want to](https://github.com/svg/svgo/blob/master/public/how-it-works/en.md). ([동작방법](https://github.com/svg/svgo/blob/master/public/how-it-works/ko.md))
