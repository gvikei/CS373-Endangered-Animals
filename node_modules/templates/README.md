...
Create a new list. See the [list public](public/lists.md) for more information about lists.
...
See the [collection public](public/collections.md) for more
...
the [create public](public/collections.md#create) for more details.
...
Define a custom static `View.context` function to override default `.context` behavior. See the [context](#context) public for more info.
...
Create an instance of `Item`. Optionally pass a default object to use. See [vinyl](http://github.com/gulpjs/vinyl) public for API details and additional documentation.
...
* `method` **{String}**: Name of the router method to handle. See [router methods](./public/router.md)
