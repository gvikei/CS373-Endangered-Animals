...
<blockquote class="babel-callout babel-callout-info">
  ...
  <p>
    You must include the <a href="https://babeljs.io/public/usage/polyfill/">polyfill</a> separately
...
You can pass in all other [options](https://babeljs.io/public/usage/api/#options) as well,
including `plugins` and `presets`. But note that the closest [`.babelrc`](https://babeljs.io/public/usage/babelrc/)
