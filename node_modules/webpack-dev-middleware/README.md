...
In order to develop a server-side rendering application, we need access to the [`stats`](https://github.com/webpack/public/wiki/node.js-api#stats), which is generated with the latest build.
