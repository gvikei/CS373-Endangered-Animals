...
[Streams API](http://nodejs.org/public/v0.5.8/api/streams.html) or the
[Http.Server API](http://nodejs.org/public/v0.5.8/api/http.html#http.Server).

### Server class

SockJS module is generating a `Server` class, similar to
[Node.js http.createServer](http://nodejs.org/public/v0.5.8/api/http.html#http.createServer)
module.
...
[http.Server instance](http://nodejs.org/public/v0.5.8/api/http.html#http.createServer).
...
[EventEmitter](http://nodejs.org/public/v0.4.10/api/events.html#events.EventEmitter),
...
[Node Stream API](http://nodejs.org/public/v0.5.8/api/streams.html) and
...
<dd><a href="http://nodejs.org/public/v0.4.10/api/http.html#request.url">Url</a>
