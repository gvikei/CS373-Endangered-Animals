...
=========================
  ...
  * Add public for new array matchers
  ...
  * Update public and migration guide
  * Convert 3 arg stub to callsFake
  * Update format public to refer to formatio
...
=========================
  ...
  * Merge pull request #1303 from dougo/public-fixups
    Docs fixups
  ...
  * Merge pull request #1301 from fatso83/1299-redirect-traffic-to-releases
    Redirect /public and /downloads to /releases
  ...
  * Merge pull request #1293 from mroderick/update-v1-public-with-bundler-warnings
  ...
  * Merge pull request #1289 from mroderick/fix-invalid-release-version-in-public
  ...
  * Merge pull request #1283 from lucasfcosta/public-stub-callThrough
    Add public for stub.callThrough()
...
=========================
  ...
  * Merge pull request #1217 from mroderick/make-public-run-on-github-pages
    Update Gemfile.lock to use latest supported Jekyll
  * Merge pull request #1213 from tiemevanveen/public-restore
  ...
  * Merge pull request #1206 from fatso83/sinon-format-public
    Update format public to refer to formatio
  * Merge pull request #1204 from estobbart/master
    Fix being able to spy Error
  * Merge pull request #1189 from mroderick/public-in-github-pages
    Prepare documentation using site in GitHub Pages
...
==================
  ...
  * Update public/TODO.md to reflect plan to Jekyll
...
==================
  ...
  * Updated public to reflect that calledOn accepts a matcher
  ...
  * Add public for sandbox and utils
  * Add documentation for matchers
  * Add public for assertions
  * Add public for JSON-P
  * Add public for fake server
  * Add public for fake timers
  ...
  * Add public TODO to track outstanding tasks
...
* Minor bug fixes and public cleanup.
