...
* Help [improve the documentation](https://github.com/sinonjs/sinon/tree/master/public) published
...
Sinon.JS uses [Mocha](https://mochajs.org/), please read those public if you're unfamiliar with it.
