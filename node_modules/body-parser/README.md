...
[Learn about the anatomy of an HTTP transaction in Node.js](https://nodejs.org/en/public/guides/anatomy-of-an-http-transaction/).
...
[in the MDN documentation about JSON.parse](https://developer.mozilla.org/en-US/public/Web/JavaScript/Reference/Global_Objects/JSON/parse#Example.3A_Using_the_reviver_parameter).
