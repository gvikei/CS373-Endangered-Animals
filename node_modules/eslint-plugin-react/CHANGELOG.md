...
* Remove deprecated [`require-extension`][] rule, use the [eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) [`extensions`](https://github.com/benmosher/eslint-plugin-import/blob/master/public/rules/extensions.md) rule instead
...
* [`jsx-wrap-multilines`][] now checks arrow functions without block body. It can be deactivated in [rule options](public/rules/jsx-wrap-multilines.md#rule-details) ([#790][] @ColCh)
* [`jsx-no-undef`][] will not check the global scope by default. You can force it with the [`allowGlobals`](public/rules/jsx-no-undef.md#allowglobals) option ([#1013][] @jomasti)
...
### Fixed
* Fix [`jsx-uses-vars`][] to work better with [`prefer-const`](http://eslint.org/public/rules/prefer-const). You'll need to upgrade to ESLint 3.4.0 to completely fix the compatibility issue ([#716][])
...
### Breaking
* Deprecate [`require-extension`][] rule, use the [eslint-plugin-import](https://github.com/benmosher/eslint-plugin-import) [`extensions`](https://github.com/benmosher/eslint-plugin-import/blob/master/public/rules/extensions.md) rule instead. [`require-extension`][] still works but will trigger a warning
...
### Breaking
* Add support for static methods to `sort-comp`. Static methods must now be declared first, see [rule documentation](public/rules/sort-comp.md) ([#128][] @lencioni)
...
* [`display-name`][] now accept the transpiler name by default. You can use the `ignoreTranspilerName` option to get the old behavior, see [rule documentation](public/rules/display-name.md#ignoretranspilername) ([#440][] @lencioni)
...
[`display-name`]: public/rules/display-name.md
[`forbid-component-props`]: public/rules/forbid-component-props.md
[`forbid-elements`]: public/rules/forbid-elements.md
[`forbid-foreign-prop-types`]: public/rules/forbid-foreign-prop-types.md
[`forbid-prop-types`]: public/rules/forbid-prop-types.md
[`no-array-index-key`]: public/rules/no-array-index-key.md
[`no-children-prop`]: public/rules/no-children-prop.md
[`no-danger`]: public/rules/no-danger.md
[`no-danger-with-children`]: public/rules/no-danger-with-children.md
[`no-deprecated`]: public/rules/no-deprecated.md
[`no-did-mount-set-state`]: public/rules/no-did-mount-set-state.md
[`no-did-update-set-state`]: public/rules/no-did-update-set-state.md
[`no-direct-mutation-state`]: public/rules/no-direct-mutation-state.md
[`no-find-dom-node`]: public/rules/no-find-dom-node.md
[`no-is-mounted`]: public/rules/no-is-mounted.md
[`no-multi-comp`]: public/rules/no-multi-comp.md
[`no-render-return-value`]: public/rules/no-render-return-value.md
[`no-set-state`]: public/rules/no-set-state.md
[`no-string-refs`]: public/rules/no-string-refs.md
[`no-unescaped-entities`]: public/rules/no-unescaped-entities.md
[`no-unknown-property`]: public/rules/no-unknown-property.md
[`no-unused-prop-types`]: public/rules/no-unused-prop-types.md
[`no-will-update-set-state`]: public/rules/no-will-update-set-state.md
[`prefer-es6-class`]: public/rules/prefer-es6-class.md
[`prefer-stateless-function`]: public/rules/prefer-stateless-function.md
[`prop-types`]: public/rules/prop-types.md
[`react-in-jsx-scope`]: public/rules/react-in-jsx-scope.md
[`require-optimization`]: public/rules/require-optimization.md
[`require-render-return`]: public/rules/require-render-return.md
[`self-closing-comp`]: public/rules/self-closing-comp.md
[`sort-comp`]: public/rules/sort-comp.md
[`sort-prop-types`]: public/rules/sort-prop-types.md
[`style-prop-object`]: public/rules/style-prop-object.md
[`jsx-boolean-value`]: public/rules/jsx-boolean-value.md
[`jsx-closing-bracket-location`]: public/rules/jsx-closing-bracket-location.md
[`jsx-curly-spacing`]: public/rules/jsx-curly-spacing.md
[`jsx-equals-spacing`]: public/rules/jsx-equals-spacing.md
[`jsx-filename-extension`]: public/rules/jsx-filename-extension.md
[`jsx-first-prop-new-line`]: public/rules/jsx-first-prop-new-line.md
[`jsx-handler-names`]: public/rules/jsx-handler-names.md
[`jsx-indent`]: public/rules/jsx-indent.md
[`jsx-indent-props`]: public/rules/jsx-indent-props.md
[`jsx-key`]: public/rules/jsx-key.md
[`jsx-max-props-per-line`]: public/rules/jsx-max-props-per-line.md
[`jsx-no-bind`]: public/rules/jsx-no-bind.md
[`jsx-no-comment-textnodes`]: public/rules/jsx-no-comment-textnodes.md
[`jsx-no-duplicate-props`]: public/rules/jsx-no-duplicate-props.md
[`jsx-no-literals`]: public/rules/jsx-no-literals.md
[`jsx-no-target-blank`]: public/rules/jsx-no-target-blank.md
[`jsx-no-undef`]: public/rules/jsx-no-undef.md
[`jsx-pascal-case`]: public/rules/jsx-pascal-case.md
[`require-default-props`]: public/rules/require-default-props.md
[`jsx-sort-props`]: public/rules/jsx-sort-props.md
[`jsx-space-before-closing`]: public/rules/jsx-space-before-closing.md
[`jsx-tag-spacing`]: public/rules/jsx-tag-spacing.md
[`jsx-uses-react`]: public/rules/jsx-uses-react.md
[`jsx-uses-vars`]: public/rules/jsx-uses-vars.md
[`jsx-wrap-multilines`]: public/rules/jsx-wrap-multilines.md
[`void-dom-elements-no-children`]: public/rules/void-dom-elements-no-children.md
[`default-props-match-prop-types`]: public/rules/default-props-match-prop-types.md
[`no-redundant-should-component-update`]: public/rules/no-redundant-should-component-update.md
[`jsx-closing-tag-location`]: public/rules/jsx-closing-tag-location.md
[`no-unused-state`]: public/rules/no-unused-state.md
[`boolean-prop-naming`]: public/rules/boolean-prop-naming.md
[`no-typos`]: public/rules/no-typos.md
[`jsx-sort-prop-types`]: public/rules/sort-prop-types.md
[`require-extension`]: public/rules/require-extension.md
[`no-comment-textnodes`]: public/rules/jsx-no-comment-textnodes.md
[`wrap-multilines`]: public/rules/jsx-wrap-multilines.md
[`jsx-curly-brace-presence`]: public/rules/jsx-curly-brace-presence.md
