...
Recursive version of [fs.readdir](http://nodejs.org/public/latest/api/fs.html#fs_fs_readdir_path_callback). Exposes a **stream api**.
...
Meant to be one of the recursive versions of [fs](http://nodejs.org/public/latest/api/fs.html) functions, e.g., like [mkdirp](https://github.com/substack/node-mkdirp).
...
- **stat**          :  built in [stat object](http://nodejs.org/public/v0.4.9/api/fs.html#fs.Stats)
