...
- [public] - Documentation upgrades across the board.
...
Note - see [rule documentation](https://github.com/evcohen/eslint-plugin-jsx-a11y/tree/master/public/rules) for updated schemas.
...
1.5.0 / 2016-06-16
==================
- [new] Add [heading-has-content](public/rules/heading-has-content.md) rule.
- [new] Add [html-has-lang](public/rules/html-has-lang.md) rule.
- [new] Add [lang](public/rules/lang.md) rule.
- [new] Add [no-marquee](public/rules/no-marquee.md) rule.
- [new] Add [scope](public/rules/scope.md) rule.
...
0.3.0 / 2016-03-02
==================
- [new] Implement [no-hash-href](public/rules/no-hash-href.md) rule.
- [fix] Fixed TemplateLiteral AST value building to get more exact values from template strings.


0.2.0 / 2016-03-01
==================
- [new] Implement [redunant-alt](public/rules/redundant-alt.md) rule.
