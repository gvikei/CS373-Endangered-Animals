...
* 0f71fef Docs: Unquote booleans in lines-between-class-members public (#9497) (Brandon Mills)
...
* e5c5e83 Build: Fixing issue with public generation (Fixes #9199) (#9200) (Ilya Volodin)
...
* e6b115c Build: Add an edit link to the rule public’ metadata (#9049) (Jed Fox)
...
* 1a89e1c Docs: Fix always-multiline example in multiline-ternary public (#8904) (Nathan Woltman)
...
* d1fc408 Docs: Update CLA link in Contributing public (#8883) (Calvin Freitas)
...
* 446b8876 Docs: update space-before-function-paren public for 4.0 (fixes #8430) (#8431) (Teddy Katz)
...
* 8569a90 Docs: add note about git's linebreak handling to linebreak-style public (#8361) (Teddy Katz)
...
* e104973 Docs: remove self-reference in no-restricted-syntax public (#8277) (Vitor Balocco)
...
* cbd7ded Build: display rules’ meta data in their public (fixes #5774) (#8127) (Wilson Kurniawan)
...
* b30116c Docs: Fix code-blocks in spaced-comment public (#7524) (Michał Gołębiowski)
...
* 8998043 Docs: fix wording in public for no-extra-parens config (Michael Ficarra)
...
* f8153ad Build: Ensure absolute links in public retain .md extensions (fixes #7419) (#7438) (Teddy Katz)
...
* 66adac1 Docs: correction in prefer-reflect public (fixes #7069) (#7150) (Scott Stern)
* e3f95de Update: Fix `no-extra-parens` false negative (fixes #7229) (#7231) (Teddy Katz)
* 2909c19 Docs: Fix typo in object-shorthand public (#7267) (Brian Donovan)
* 7bb800d Chore: add internal rule to enforce meta.public conventions (fixes #6954) (#7155) (Vitor Balocco)
...
* 87625fa Docs: Improve eol-last examples in public (#7227) (Chainarong Tangsurakit)
...
* f02e52a Docs: Add fixable note to no-implicit-coercion public (#7096) (Brandon Mills)
...
* 6947299 Docs: Add info about closing accepted issues to public (fixes #6979) (#7089) (Kai Cataldo)
...
* 16db93a Build: Tag public, publish release notes (fixes #6892) (#6934) (Nicholas C. Zakas)
...
* 117e7aa Docs: Remove incorrect "constructor" statement from `no-new-symbol` public (#6830) (Jarek Rencz)
...
* e7b1e1c Docs: Edit issue/PR waiting period public (fixes #6009) (#6715) (Nicholas C. Zakas)
...
* 4c05967 Docs: Update rule public for new format (fixes #5417) (#6551) (Nicholas C. Zakas)
...
* 16fad58 Merge pull request #6088 from eslint/public-one-var-per-line (alberto)
...
* ad10106 Docs: Update comma-style public (#6039) (Kai Cataldo)
...
* 249732e Docs: Move public from eslint.github.io (fixes #5964) (#6012) (Nicholas C. Zakas)
* 4c2de6c Docs: Add example of diff clarity to comma-dangle rule public (#6035) (Vitor Balocco)
...
* 43f6d05 Docs: Update public to refer to column (#5937) (Sashko Stubailo)
...
* af3113c Docs: Fix config comments in indent public (Brandon Mills)
...
* a9f0865 Docs: Update no-sequences rule public for clarity (fixes #5536) (Kai Cataldo)
...
* 38a0a64 Docs: Clarify `linebreak-style` public (fixes #5628) (alberto)
...
* c335650 Docs: correct the no-confusing-arrow public (Daniel Norman)
...
* 124c447 Build: Add additional linebreak to public (fixes #5464) (Ilya Volodin)
...
* 7de5ae4 Docs: Missing allow option in  public (Scott O'Hara)
...
* fd07925 Docs: Clarify public for api.verify (fixes #5101, fixes #5104) (Burak Yigit Kaya)
...
* 02c83df Docs: Update public/rules/no-plusplus.md (Sheldon Griffin)
...
* fc9f528 Docs: Modify unnecessary flag public in quote-props (Matija Marohnić)
...
* Docs: Update public/rules/no-plusplus.md (Xiangyun Chi)
...
* Docs: Update strict rule public (fixes #4583) (Nicholas C. Zakas)
* Docs: Reference .eslintrc.* in contributing public (fixes #4532) (Kai Cataldo)
...
* Fix: Add the missing "as-needed" public to the radix rule (fixes #4364) (Michał Gołębiowski)
...
* Docs: update public about using gitignore (Mateusz Derks)
...
* Docs: Update various rules public (Nicholas C. Zakas)
...
* Docs: Fix method signature on working-with-rules public (fixes #3862) (alberto)
...
* Build: Fix formatter public generation (fixes #3847) (Nicholas C. Zakas)
...
* Build: Generate formatter example public (fixes #3560) (Ian VanSchooten)
* New: Add --debug flag to CLI (fixes #2692) (Nicholas C. Zakas)
* Docs: Update no-undef-init public (fixes #3170) (Nicholas C. Zakas)
* Docs: Update no-unused-expressions public (fixes #3685) (Nicholas C. Zakas)
* Docs: Clarify node types in no-multi-spaces (fixes #3781) (Nicholas C. Zakas)
* Docs: Update new-cap public (fixes #3798) (Nicholas C. Zakas)
...
* Docs: Fix closing code fence on cli public (Ian VanSchooten)
...
* Docs: Add new formatters to API public (Ian VanSchooten)
...
* Docs: Make `quotes` public clearer (fixes #3646) (Nicholas C. Zakas)
...
* Docs: Add linting for second half of rule public (refs #2271) (Ian VanSchooten)
...
* Docs: Update public for no-iterator (fixes #3405) (Nicholas C. Zakas)
...
* Docs: Update no-unused-var public (Nicholas C. Zakas)
...
* Docs: Clarify `no-process-env` public (fixes #3318) (Nicholas C. Zakas)
...
* Docs: Fix typo in object-shorthand public (Gunnar Lium)
...
* public: additional computed-property-spacing documentation (fixes #2941) (Jamund Ferguson)
...
* Docs: eol-last public fix (fixes #2755) (Gyandeep Singh)
...
* Docs: Fix mistakes in object-curly-spacing public (Matthew Dapena-Tretter)
...
* Docs: Update public for token-related methods (fixes #1878) (Nicholas C. Zakas)
...
* Docs: fix typo in configuring public (mendenhallmagic)
...
* Docs: add webpack loader to the public/integrations page (Maxime Thirouin)
...
* Docs: fixed typo in no-lone-blocks public (Vitor Balocco)
* Docs: fixed typo in consistent-return public (Vitor Balocco)
...
* Docs: change 'and' to 'an' in public/rules/valid-jsdoc.md (fixes #1441) (Michael Ficarra)
...
* Docs: Fix broken code fences in key-spacing public (Brandon Mills)
...
* Docs: Add public on Node.js API (fixes #1247) (Nicholas C. Zakas)
...
* Build: add version numbers to public (fixes #1170) (Mathias Schreck)
...
* public: Update link (Mathias Bynens)
...
* Build + Docs: Adding generated resource links to rule public (Fixes #1021) (jrajav)
...
* Build: Makefile - Check for rule ids in public titles (Fixes #969) (Delapouite)
...
* 0.6.2 (Nicholas C. Zakas)
* Fix: Adding per-environment rule configs to public and doc validation (Fixes #918) (jrajav)
...
* Docs: Fix layout issue in configuration public (fixes #889) (Nicholas C. Zakas)
...
* Build: Always build public site on top of origin/master (Nicholas C. Zakas)
...
* recommend using hasOwnProperty from Object.prototype in guard-for-in public (Michael Ficarra)
...
* fix 'node-modules' typo in public (Fred K. Schott)
...
* Added a TextMate 2 integration to the public (Nate Silva)
...
* Added broccoli-eslint to integration public (Christian)
...
* #595 add public for rule func-names (Kyle Nunery)
...
* #580 Remove eslint.getAllComments(), related public, related tests (Christian)
...
* Docs: Add public for no-regex-spaces and all doc errors now break build (closes #562) (Nicholas C. Zakas)
* Rename: regex-spaces to no-regex-spaces (Nicholas C. Zakas)
* Docs: Add public for no-underscore-dangle (refs #562) (Nicholas C. Zakas)
* Docs: Add public for no-undef-init (refs #562) (Nicholas C. Zakas)
* Docs: Add public for no-return-assign (refs #562) (Nicholas C. Zakas)
* Fix: Misspelling in no-return-assign message (Nicholas C. Zakas)
* Docs: Add public for no-new-wrappers (refs #562) (Nicholas C. Zakas)
* Docs: Add public for no-new-object (refs #562) (Nicholas C. Zakas)
* Docs: Add public for no-implied-eval (refs #562) (Nicholas C. Zakas)
...
* Docs: Added no-floating-decimal public (refs #562) (Nicholas C. Zakas)
* New Rule: no-path-concat (fixes #540) (Nicholas C. Zakas)
* Docs: Add some missing rule public (refs #562) (Nicholas C. Zakas)
...
* Docs: Add public for no-fallthrough rule (Nicholas C. Zakas)
...
* Typo (Mangled Deutz)
* Fixed public typo (Nicholas C. Zakas)
...
* update public: explicit cli args are exempt from eslintignore exclusions (Michael Ficarra)
...
* Add build task to check for missing public and tests for rules (Nicholas C. Zakas)
...
* Change quotes option to avoid-escapes and update public (fixes #199) (Brandon Payton)
...
* public: add documentation for quotes rule (Matthew DuVall)
...
* Add some public (Jamund Ferguson)
...
* Update public related to running unit tests (Nicholas C. Zakas)
...
* Fix a broken link in the public (Brian J Brennan)
...
* Add public for rule (Matt DuVall)
...
* Updated public for no-unused vars rule. (Andrew de Andrade)
...
* Added public for eqeqeq and no-with (fixes #262) (Raphael Pigulla)
...
* Added acceptance criteria for rules to public (Nicholas C. Zakas)
...
* Put all rules into strict mode and update public accordingly (Nicholas C. Zakas)
* Merge branch 'master' of github.com:nzakas/jscheck (Nicholas C. Zakas)
...
* add public for no-exc-assign (Stephen Murray)
...
* public: Clean up structure (Mathias Bynens)
...
* Removes line length from code style convention public (Josh Perez)
...
* Fixes #90 -- updates publictrings (Stephen Murray)
...
* Add wiki files to public directory (Evan Goer)
