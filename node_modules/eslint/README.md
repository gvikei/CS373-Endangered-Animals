...
[Configuring](https://eslint.org/public/user-guide/configuring) |
[Rules](https://eslint.org/public/rules/) |
[Contributing](https://eslint.org/public/developer-guide/contributing) |
[Reporting Bugs](https://eslint.org/public/developer-guide/contributing/reporting-bugs) |
...
The names `"semi"` and `"quotes"` are the names of [rules](https://eslint.org/public/rules) in ESLint. The first value is the error level of the rule and can be one of these values:

* `"off"` or `0` - turn the rule off
* `"warn"` or `1` - turn the rule on as a warning (doesn't affect exit code)
* `"error"` or `2` - turn the rule on as an error (exit code will be 1)

The three error levels allow you fine-grained control over how ESLint applies rules (for more configuration options and details, see the [configuration public](https://eslint.org/public/user-guide/configuring)).
...
* [Bug Report](https://eslint.org/public/developer-guide/contributing/reporting-bugs)
* [Propose a New Rule](https://eslint.org/public/developer-guide/contributing/new-rules)
* [Proposing a Rule Change](https://eslint.org/public/developer-guide/contributing/rule-changes)
* [Request a Change](https://eslint.org/public/developer-guide/contributing/changes)
...
Yes, ESLint natively supports parsing JSX syntax (this must be enabled in [configuration](https://eslint.org/public/user-guide/configuring).). Please note that supporting JSX syntax *is not* the same as supporting React. React applies specific semantics to JSX syntax that ESLint doesn't recognize. We recommend using [eslint-plugin-react](https://www.npmjs.com/package/eslint-plugin-react) if you are using React and want React semantics.

### What about ECMAScript 6 support?

ESLint has full support for ECMAScript 6. By default, this support is off. You can enable ECMAScript 6 syntax and global variables through [configuration](https://eslint.org/public/user-guide/configuring).

### What about experimental features?

ESLint doesn't natively support experimental ECMAScript language features. You can use [babel-eslint](https://github.com/babel/babel-eslint) to use any option available in Babel.

Once a language feature has been adopted into the ECMAScript standard (stage 4 according to the [TC39 process](https://tc39.github.io/process-document/)), we will accept issues and pull requests related to the new feature, subject to our [contributing guidelines](https://eslint.org/public/developer-guide/contributing). Until then, please use the appropriate parser and plugin(s) for your experimental feature.
