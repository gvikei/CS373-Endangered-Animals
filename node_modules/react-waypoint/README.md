...
- `event` - the native [scroll
  event](https://developer.mozilla.org/en-US/public/Web/Events/scroll) that
...
destructuring](https://developer.mozilla.org/en/public/Web/JavaScript/Reference/Operators/Destructuring_assignment),
