...
- [public] add note about `install-peerdeps` (#1234)
- [public] Updated instructions to support non-bash users (#1214)
...
- [Tests] on `node` `v7`
- [public] ensure latest version of config is installed (#1121)
...
- [public] use “#” in example command rather than version numbers (#984)
...
- [public] update the peer dep install command to dynamically look up the right version numbers when installing peer deps
...
- [public] flesh out react rule defaults ([#618](https://github.com/airbnb/javascript/issues/618))
...
[array-bracket-spacing]: http://eslint.org/public/rules/array-bracket-spacing
[array-callback-return]: http://eslint.org/public/rules/array-callback-return
[arrow-body-style]: http://eslint.org/public/rules/arrow-body-style
[arrow-spacing]: http://eslint.org/public/rules/arrow-spacing
[computed-property-spacing]: http://eslint.org/public/rules/computed-property-spacing
[id-length]: http://eslint.org/public/rules/id-length
[indent]: http://eslint.org/public/rules/indent
[max-len]: http://eslint.org/public/rules/max-len
[newline-per-chained-call]: http://eslint.org/public/rules/newline-per-chained-call
[no-confusing-arrow]: http://eslint.org/public/rules/no-confusing-arrow
[no-const-assign]: http://eslint.org/public/rules/no-const-assign
[no-mixed-spaces-and-tabs]: http://eslint.org/public/rules/no-mixed-spaces-and-tabs
[no-multiple-empty-lines]: http://eslint.org/public/rules/no-multiple-empty-lines
[no-new-symbol]: http://eslint.org/public/rules/no-new-symbol
[no-restricted-imports]: http://eslint.org/public/rules/no-restricted-imports
[no-self-assign]: http://eslint.org/public/rules/no-self-assign
[no-undef]: http://eslint.org/public/rules/no-undef
[no-useless-constructor]: http://eslint.org/public/rules/no-useless-constructor
[no-whitespace-before-property]: http://eslint.org/public/rules/no-whitespace-before-property
[object-curly-spacing]: http://eslint.org/public/rules/object-curly-spacing
[object-shorthand]: http://eslint.org/public/rules/object-shorthand
[one-var-declaration-per-line]: http://eslint.org/public/rules/one-var-declaration-per-line
[prefer-arrow-callback]: http://eslint.org/public/rules/prefer-arrow-callback
[prefer-rest-params]: http://eslint.org/public/rules/prefer-rest-params
[prefer-template]: http://eslint.org/public/rules/prefer-template
[quote-props]: http://eslint.org/public/rules/quote-props
[space-before-function-paren]: http://eslint.org/public/rules/space-before-function-paren
[space-before-keywords]: http://eslint.org/public/rules/space-before-keywords
[space-in-parens]: http://eslint.org/public/rules/space-in-parens
[template-curly-spacing]: http://eslint.org/public/rules/template-curly-spacing

[react/jsx-space-before-closing]: https://github.com/yannickcr/eslint-plugin-react/blob/master/public/rules/jsx-space-before-closing.md
[react/sort-comp]: https://github.com/yannickcr/eslint-plugin-react/blob/master/public/rules/sort-comp.md
[react/display-name]: https://github.com/yannickcr/eslint-plugin-react/blob/master/public/rules/display-name.md
[react/jsx-no-bind]: https://github.com/yannickcr/eslint-plugin-react/blob/master/public/rules/jsx-no-bind.md
[react/no-is-mounted]: https://github.com/yannickcr/eslint-plugin-react/blob/master/public/rules/no-is-mounted.md
[react/prefer-es6-class]: https://github.com/yannickcr/eslint-plugin-react/blob/master/public/rules/prefer-es6-class.md
[react/jsx-quotes]: https://github.com/yannickcr/eslint-plugin-react/blob/f817e37beddddc84b4788969f07c524fa7f0823b/public/rules/jsx-quotes.md
[react/prefer-stateless-function]: https://github.com/yannickcr/eslint-plugin-react/blob/master/public/rules/prefer-stateless-function.md
