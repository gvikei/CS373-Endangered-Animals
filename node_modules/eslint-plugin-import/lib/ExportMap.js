...
exports.default = ExportMap; /**
                              * parse public from the first node that has leading comments
...
ExportMap.parse = function (path, content, context) {
  ...
  const publictyle = context.settings && context.settings['import/publictyle'] || ['jsdoc'];
  const docStyleParsers = {};
  publictyle.forEach(style => {
