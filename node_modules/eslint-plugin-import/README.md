...
[`no-unresolved`]: ./public/rules/no-unresolved.md
[`named`]: ./public/rules/named.md
[`default`]: ./public/rules/default.md
[`namespace`]: ./public/rules/namespace.md
[`no-restricted-paths`]: ./public/rules/no-restricted-paths.md
[`no-absolute-path`]: ./public/rules/no-absolute-path.md
[`no-dynamic-require`]: ./public/rules/no-dynamic-require.md
[`no-internal-modules`]: ./public/rules/no-internal-modules.md
[`no-webpack-loader-syntax`]: ./public/rules/no-webpack-loader-syntax.md
...
[`export`]: ./public/rules/export.md
[`no-named-as-default`]: ./public/rules/no-named-as-default.md
[`no-named-as-default-member`]: ./public/rules/no-named-as-default-member.md
[`no-deprecated`]: ./public/rules/no-deprecated.md
[`no-extraneous-dependencies`]: ./public/rules/no-extraneous-dependencies.md
[`no-mutable-exports`]: ./public/rules/no-mutable-exports.md
...
[`unambiguous`]: ./public/rules/unambiguous.md
[`no-commonjs`]: ./public/rules/no-commonjs.md
[`no-amd`]: ./public/rules/no-amd.md
[`no-nodejs-modules`]: ./public/rules/no-nodejs-modules.md
...
[`first`]: ./public/rules/first.md
[`exports-last`]: ./public/rules/exports-last.md
[`no-duplicates`]: ./public/rules/no-duplicates.md
[`no-namespace`]: ./public/rules/no-namespace.md
[`extensions`]: ./public/rules/extensions.md
[`order`]: ./public/rules/order.md
[`newline-after-import`]: ./public/rules/newline-after-import.md
[`prefer-default-export`]: ./public/rules/prefer-default-export.md
[`max-dependencies`]: ./public/rules/max-dependencies.md
[`no-unassigned-import`]: ./public/rules/no-unassigned-import.md
[`no-named-default`]: ./public/rules/no-named-default.md
[`no-anonymous-default-export`]: ./public/rules/no-anonymous-default-export.md
...
[`externals`]: http://webpack.github.io/public/library-and-externals.html
...
In practice, this means rules other than [`no-unresolved`](./public/rules/no-unresolved.md#ignore) will not report on any
`import`s with (absolute filesystem) paths matching this pattern.

`no-unresolved` has its own [`ignore`](./public/rules/no-unresolved.md#ignore) setting.
...
See the SublimeLinter public on [`chdir`](http://www.sublimelinter.com/en/latest/linter_settings.html#chdir)
